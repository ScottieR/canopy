...
**Date:** July 18, 2026  
**Status:** Proposed  
**Related:** [`../product/heartbeats-app-plan.md`](../product/heartbeats-app-plan.md)
...
- [`../product/heartbeats-app-plan.md`](../product/heartbeats-app-plan.md)
...
- App-specific screens, flows, and component breakdowns belong in [`../product/heartbeats-app-plan.md`](../product/heartbeats-app-plan.md).
