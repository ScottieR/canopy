...
export function AccountantLobster({ position = [0, 0, 0], scale = 1.6 }: { position?: number[], scale?: number }) {
  ...
  const peach = "#E09075";
  const darkPeach = "#C47A60";
  const tan = "#F2DBAD";
  const darkGrey = "#2A2A2A";
  const tabletGreen = "#6CA18B";
  ...
  return (
    <group position={position as any} scale={scale} ref={ref}>
      ...
      <mesh position={[0, 0.65, 0]}>
        ...
        <meshStandardMaterial color={peach} roughness={0.4} flatShading={false} />
      </mesh>
      ...
      <group position={[0, 0.45, 0]}>
        <mesh>
          ...
          <meshStandardMaterial color={tan} roughness={0.8} flatShading={false} />
        </mesh>
      ...
      <group position={[0, 0.15, -0.1]} rotation={[0.4, 0, 0]}>
        <mesh position={[0, 0, -0.05]}>
          ...
          <meshStandardMaterial color={tan} roughness={0.6} flatShading={false} />
        </mesh>
        <mesh position={[0, -0.14, -0.05]}>
          <cylinderGeometry args={[0.18, 0.15, 0.15, 32]} />
          <meshStandardMaterial color={darkPeach} roughness={0.6} flatShading={false} />
        </mesh>
        ...
        <mesh position={[0, -0.45, -0.05]} scale={[1, 1, 0.4]}>
          ...
          <meshStandardMaterial color={peach} roughness={0.6} flatShading={false} />
        </mesh>
      </group>
      ...
      <group position={[0, 0.85, 0]}>
        <mesh position={[-0.05, 0.08, -0.03]} rotation={[0.2, 0, 0.3]} scale={[1, 7, 1]}><sphereGeometry args={[0.015, 16, 16]} /><meshStandardMaterial color={peach} flatShading={false} /></mesh>
        <mesh position={[0.05, 0.08, -0.03]} rotation={[0.2, 0, -0.3]} scale={[1, 7, 1]}><sphereGeometry args={[0.015, 16, 16]} /><meshStandardMaterial color={peach} flatShading={false} /></mesh>
      </group>

      {/* Arms & Claws */}
      <group position={[-0.20, 0.45, 0.1]} rotation={[0, 0, -0.3]}>
        <mesh position={[0, -0.08, 0]} rotation={[Math.PI/4, 0, 0]}><capsuleGeometry args={[0.035, 0.15, 16, 16]} /><meshStandardMaterial color={tan} flatShading={false} /></mesh>
        <mesh position={[0, -0.15, 0.08]} rotation={[0.5, 0.2, 0]} scale={[1, 1.4, 0.8]}><sphereGeometry args={[0.055, 32, 32]} /><meshStandardMaterial color={darkPeach} flatShading={false} /></mesh>
      </group>
      <group position={[0.20, 0.45, 0.1]} rotation={[0, 0, 0.3]}>
        <mesh position={[0, -0.08, 0]} rotation={[Math.PI/4, 0, 0]}><capsuleGeometry args={[0.035, 0.15, 16, 16]} /><meshStandardMaterial color={tan} flatShading={false} /></mesh>
        <mesh position={[0, -0.15, 0.08]} rotation={[0.5, -0.2, 0]} scale={[1, 1.4, 0.8]}><sphereGeometry args={[0.055, 32, 32]} /><meshStandardMaterial color={darkPeach} flatShading={false} /></mesh>
      ...
      <group position={[0, 0.35, 0.24]} rotation={[-0.4, 0, 0]}>
        <mesh><boxGeometry args={[0.35, 0.22, 0.02]} /><meshStandardMaterial color={tabletGreen} roughness={0.3} /></mesh>
