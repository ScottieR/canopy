...
**Date:** July 18, 2026  
**Status:** Proposed  
**Related:** `canopy/heartbeats.md`, `canopy/ONBOARDING_AND_AGENT_DISCOVERY_PRD_2026-07-17.md`, `Canopy - Technical Specification.md`
...
It is intentionally separate from `canopy/heartbeats.md`, which should remain focused on the OpenClaw-facing `HEARTBEAT.md` runtime contract.
